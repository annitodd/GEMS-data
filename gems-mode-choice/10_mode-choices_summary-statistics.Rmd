...
author: "Annika"
date: "Created on 10/21/2023. Last compiled on `r Sys.Date()`"
...
This code opens datasets from NHTS data in 2017, cleans them, saves as new datasets. The second half of this code, provides very basic summary stats.
...
```{r}
datadir <- 'C:/FHWA/For FHWA folks/Mode_choice_estimation/Data'
```
...
```{r}
trippub <- read_csv(file=file.path(datadir, 'trippub.csv'))
#View(trippub)
```
