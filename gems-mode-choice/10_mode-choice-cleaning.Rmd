...
match fips codes with the microtypes and geotypes \### for origin first rename so can merge a little later
...
df_geoID_origin <- df_geoID_origin %>% 
  unite(origin_microtypeXgeotype_ATB,c("origin_microtype_ATB","origin_geotype_ATB"),sep="_",remove = FALSE)
